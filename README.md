...
|------|----------------|------|--------|------------|-----------|----------|-------------|-------|
| **REAL** | **LSMOD** (2019) | Low-Light Video Enhancement | RAW | 1800×1000 | 179 | ~36k | ❌ | [Paper (ICCV)](https://openaccess.thecvf.com/content_ICCV_2019/papers/Jiang_Learning_to_See_Moving_Objects_in_the_Dark_ICCV_2019_paper.pdf) • [Code (GitHub)](https://github.com/MichaelHYJiang/Learning-to-See-Moving-Objects-in-the-Dark) |
...
|  | **Real-LLRVD** (2022) | Low-Light Enhancement | RAW | 3840×2160 (downscaled) | 210 | — | ❌ | *Contact authors* ([BIT ISP Lab](mailto:bit-isp@bit.edu.cn)) • [Related work (arXiv:2305.00767)](https://arxiv.org/abs/2305.00767) |
|  | **ReCRVD** (2025) | RAW Video Denoising | RAW | 1920×1080 | 120 | ~1,200 | ✅ | [GitHub (RViDeformer)](https://github.com/cao-cong/RViDeformer) • [Baidu (key: `ogyw`)](https://pan.baidu.com/s/1...) |
|  | **AIM 2025 Challenge** (2025) | Mobile RAW Denoising | RAW | 14 sensors (2592×1940 to 4080×3072) | 756 sequences | 7,560 | ⚠️ (registration) | [Challenge](https://www.aim-2025.org) • [Paper (arXiv:2508.16830)](https://arxiv.org/abs/2508.16830) |
